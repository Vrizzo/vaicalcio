...
/**
 *
 * Classe che gestisce la cache per le info dell'applicazione,associando una chiave (key) all'oggetto da memorizzare
 */
public class InfoCache
{
  ...
  private static final Logger logger = Logger.getLogger(InfoCache.class);
  private static final String CACHE_NAME = "it.newmedia.gokick.cache.InfoCache";
