...
<%!
    //
    //CAMBIARE QUESTI VALORI IN FUNZIONE DELL'APPLICAZIONE DA GESTIRE (tutto ciò che inizia con NMSTEMPLATE )
    public static final String SITE_URL = "NMSTEMPLATE sito.it";
    public static final String SECURITY = "NMSTEMPLATE sito-it";
    public static final String MAIL_FROM = "NMSTEMPLATE";
    public static final String MAIL_SMTP_SERVER = "NMSTEMPLATE ";
    public static final String MAIL_USERNAME = "NMSTEMPLATE ";
    public static final String MAIL_PASSWORD = "NMSTEMPLATE ";
    ...
    public static final String JDBC_ALIAS = "jdbc/NMSTEMPLATE";
    /**
     * QUERY E ALTRO...
     */
...
<div class="wrapper">
    ...
    <div class="header">
        ...
        <h2><a href="http://<%= SITE_URL%>" target="_blank"><%= SITE_URL%>
        </a></h2>
    </div>
    ...
    <table>
        ...
        <tr>
            ...
            <td><big class="<%= APPLICATION_SERVER_STATUS%>"><%= APPLICATION_SERVER_STATUS%>
            </big></td>
            <td>
                <%= APPLICATION_SERVER%> -
                Processori
        ...
        <tr>
            ...
            <td><big class="<%= databaseReadStatus%>"><%= databaseReadStatus%>
            </big></td>
            <td><%= databaseRead%>
            </td>
        </tr>
        <tr>
            ...
            <td><big class="<%= databaseUpdateStatus%>"><%= databaseUpdateStatus%>
            </big></td>
            <td><%= databaseUpdate%>
            </td>
        </tr>
        <tr>
            ...
            <td><big class="<%= mailSendStatus%>"><%= mailSendStatus%>
            </big></td>
            <td><%= mailSend%>
            </td>
        </tr>
