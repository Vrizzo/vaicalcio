...
public class EmailProvider {
   ...
   * @throws Exception
   */
  public static AEmailHelper getEmailHelper(EnumEmailConfigurationType emailConfigurationType, Language language, Cobrand currentCobrand) throws Exception
  {
    return getEmailHelper(emailConfigurationType, language, currentCobrand, -1);
  }
   ...
   * @throws Exception
   */
  public static AEmailHelper getEmailHelper(EnumEmailConfigurationType emailConfigurationType, Language language, Cobrand currentCobrand, int idUser) throws Exception
  {
    ...
    {
      language = InfoProvider.getDefaultLanguage();
    }
    ...
    // Oggetto
    translation = TranslationProvider.getTranslation(emailConfiguration.getKeyNameSubject(), language, idUser, currentCobrand);
    aEmailHelper.setSubject(translation.getKeyValue());

    //Corpo del messaggio
    translation = TranslationProvider.getTranslation(emailConfiguration.getKeyNameBody(), language, idUser, currentCobrand);
