 ...
 */
package it.newmedia.gokick.site.web.taghandlers;
 ...
 * @author ssalmaso
 */
public class DateFormatTagHandler extends BodyTagSupport
{
  ...
  public int doStartTag() throws JspException
  {
    ...
    {
      JspWriter out = pageContext.getOut();
      out.println(DateManager.showDate(this.date, this.formatKey));
    }
    catch (IOException e)
    {
      //System.out.println("Error in DateFormatTagHandler.doStartTag()");
      //e.printStackTrace();
  ...
  private void handleBodyContentException(Exception ex) throws JspException
  {
    ...
    throw new JspException("Error in DateFormatTagHandler tag", ex);
  }
