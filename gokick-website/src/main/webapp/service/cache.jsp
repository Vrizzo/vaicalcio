...
<%!//
  ...
  public static final String SITE_URL = "preview.gokick.it";
...
<html  xmlns="http://www.w3.org/1999/xhtml" xml:lang="IT" lang="IT">
  <head>
    ...
    <style type="text/css">
      ...
      h1{margin:0; padding:0; font: normal 20px Arial; color: #799ecb;}
      ...
      a.backTo, a.backTo:visited, a.backTo:hover{font: normal 16px Arial; color: #799ecb;}
    </style>
   
  </head>
  <body>
    <h1>Cache Management :: <a class="backTo" href="http://<%= SITE_URL%>" >Torna a <%= SITE_URL%></a></h1>
