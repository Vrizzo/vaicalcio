    ...
    <div class="wrapper">
      ...
      <div class="centralCol">
        ...
        <div class="mainContent">
            <p><u:translation key="label.userSettingsViewSettings"/></p>
            <s:form action="saveUserSettings" >
              <s:textfield name="currentUser.firstName" cssStyle="border:solid 1px #999999; background:#FFFFFF;" />
